async function AboutSection() {
  return (
    <div className="w-full absolute left-2 sm:left-2 bottom-2 flex flex-row">
      <section className="w-full lg:w-1/2 text-slate-200 text-justify">
        <div className="mr-4 select-none">
          ...
          <span
            className="hover:text-black ease-in-out duration-500 text-slate-200 text-xs xss:text-sm sm:text-2xl md:text-3xl lg:text-xl"
      ...
      <section className="w-1/2 hidden lg:flex justify-center items-center gap-4">
        <svg

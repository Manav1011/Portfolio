...
async function LuffyGraphic() {
  return (
    // <div className="w-full h-full flex justify-end">
      <section id="ActivityCalender" className="popUp hidden w-full h-[100dvh] text-slate-200 flex md:justify-start lg2:justify-start xl:justify-end xl:items-end flex-col overflow-hidden">      
